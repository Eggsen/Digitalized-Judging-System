...
<body class="min-h-screen bg-slate-50 font-sans text-slate-800 flex flex-col justify-between antialiased"
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 sm:p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200/70 hover:shadow-md transition-all">
                    <div
                        class="w-10 h-10 rounded-xl bg-buksu-navy text-buksu-gold flex items-center justify-center text-lg mb-3">
                ...
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200/70 hover:shadow-md transition-all">
                    ...
                    <p class="text-xs text-slate-500 mt-1">Monitor connected judges, score submissions, and
                        participants.</p>
                </div>
                ...
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200/70 hover:shadow-md transition-all">
                    ...
                    <p class="text-xs text-slate-500 mt-1">Audit score entries and generate printable result summaries.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 sm:p-10 mt-5">
                <div class="flex items-center gap-3 mb-8 border-b border-slate-100 pb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-0.5">Create and manage Judge &amp; Tabulator accounts, and
                            control their access permissions.</p>
                    </div>
                </div>
                        ...
                        <form id="createAccountForm" onsubmit="return false;" class="space-y-5">
                            <div>
                                ...
                                <select id="create-role"
                                    class="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none focus:border-buksu-navy focus:ring-2 focus:ring-buksu-navy/10 transition-all">
                            ...
                            <div>
                                <label class="block text-xs font-semibold text-slate-700 mb-1.5">Username <span
                                        class="text-rose-500">*</span></label>
                                <div class="relative">
                                    <div
                                    ...
                                    <input type="text" id="create-username" placeholder="e.g. judge01 or tab_smith"
                                        class="w-full ps-9 pe-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-buksu-navy focus:ring-2 focus:ring-buksu-navy/10 transition-all">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" id="create-email" placeholder="email@buksu.edu.ph"
                                        class="w-full ps-9 pe-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-buksu-navy focus:ring-2 focus:ring-buksu-navy/10 transition-all">
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-3 mt-5">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button id="refreshAccountsBtn"
                                class="text-xs text-slate-500 hover:text-buksu-navy transition-colors flex items-center gap-1.5 cursor-pointer">
                            ...
                            <table class="w-full text-xs">
                                <thead>
                                    <tr class="bg-slate-50 border-b border-slate-200">
                                        <th
                                            class="px-4 py-3 text-left font-semibold text-slate-500 uppercase tracking-wider">
                                            Username</th>
                                        <th
                                            class="px-4 py-3 text-center font-semibold text-slate-500 uppercase tracking-wider">
                                            Role</th>
                                        <th
                                            class="px-4 py-3 text-center font-semibold text-slate-500 uppercase tracking-wider">
                                            Status</th>
    ...
    <footer class="w-full py-4 text-center text-xs text-slate-400 border-t border-slate-200 bg-white">
        <p>&copy; 2026 intFour. All rights reserved. | <span class="font-medium text-slate-500">Digitalized Judging
                System</span></p>
    </footer>
